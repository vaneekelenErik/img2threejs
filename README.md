...
3. Attach the image (or `@`-mention the path) and invoke `/img2threejs` — or paste from `reconstructions/pearl-smart-ring/PROMPT.md`.

This branch already includes **multi-view / turnaround** packaging (`grid-2x2`, `referenceViews`).

### Install / invoke the skill
